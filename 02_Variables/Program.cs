...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.Write("Yolcu Tc Kinlik No: ");
            //passengerIdentityNumber = Console.ReadLine();


            //Console.WriteLine();
            //Console.WriteLine("--------------------------");
            //Console.Write("Yolcu : " + passengerName + " " + passengerSurname + " " + passengerSurname + " " + passengerDistrict + " / " + passengerCity + " " + passengerAge + " " + passengerIdentityNumber);
            #endregion
