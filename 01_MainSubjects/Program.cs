...
//Kullanılan kodlara ait kütüphanaler
...
namespace _01_MainSubjects
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            int totalPrice = totalHambugerPrice + totalLemonadePrice + totalCokePrice + totalWaterPrice + totalFriesPrice + totalPizzaPrice;
